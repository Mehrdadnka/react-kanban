...
const createDemoTasks = (): Task[] => {
  ...
  return [
    ...
    {
      ...createDefaultTask('doing', 1),
      id: doingId,
      title: 'Add milestones to your tasks',
      shortDescription: 'Organize tasks with milestones',
      description: 'Milestones help you track progress towards bigger goals.\n\nGroup related tasks under a milestone to see the big picture.',
      type: 'milestone',
      priority: 'high',
      labels: [],
      milestoneIds: [],
      ...
      createdAt: now,
      updatedAt: now,
      activityLog: [createLog(doingId, 'created')],
    },
    {
      ...createDefaultTask('done', 2),
      id: doneId,
